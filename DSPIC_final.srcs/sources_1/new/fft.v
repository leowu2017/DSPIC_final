...
reg `BITS_RANGE mult1_o_real,mult1_o_imag,mult2_o_real,mult2_o_imag,mult3_o_real,mult3_o_imag;
wire twiddle_factor1_real,twiddle_factor1_imag,twiddle_factor2_real,twiddle_factor2_imag,twiddle_factor3_real,twiddle_factor3_imag;
wire `BITS_RANGE flag1,flag2,flag3,flag4;
...
LUT_twiddle_factor_control_units(twiddle_factor1_real,twiddle_factor1_imag,twiddle_factor2_real,twiddle_factor2_imag,twiddle_factor3_real,twiddle_factor3_imag,counter1,counter2,counter3);
...
begin
    if(~rst)
        counter1_tmp = 0;
    else if(counter1<`COUNTER_BITS'd15 && flag1 && en)
...
begin
    if(~rst)
        counter2_tmp = 0;
    else if(counter2<`COUNTER_BITS'd15 && flag2 && en)
...
begin
    if(~rst)
        counter3_tmp = 0;
    else if(counter3<`COUNTER_BITS'd15 && flag3 && en)
